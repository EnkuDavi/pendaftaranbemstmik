        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="alert alert-warning text-center" role="alert">
                    Pemilihan Ketua BEM STMIK Pamitran Karawang
                </div>
                <br>
                <h6 class="text-center">Kandidat Calon Ketua BEM Periode 2020-2021</h6>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-inline">
                                        <li class="list-inline-item"> <a href="<?php echo base_url(''); ?>/admin/hapus/<?php echo $kandidats['id']; ?>" class="badge badge-danger float-right list-inline" onclick="return confirm('Yakin ?');">Hapus</a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
